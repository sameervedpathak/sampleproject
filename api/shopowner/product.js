...
/**
 * @api {get} /shop/allproduct generate list of products
 * @apiName findAll
 * @apiGroup /ShopOwner/product
 *
 */
...
/**
 * @api {get} /shop/getproduct/:id get particuler product details
 * @apiName findById
 * @apiGroup /ShopOwner/product
 *
 */
...
/**
 * @api {post} /shop/addproduct/   add new product
...
/**
 * @api {post} /shop/editproduct/   update product details
...
/**
 * @api {get} /shop/deleteProduct/:id delete particuler product from database
